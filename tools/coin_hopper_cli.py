...
def main():
    ...
    p.add_argument('--one-pin', type=int, default=17, help='GPIO pin for 1-peso hopper motor')
    p.add_argument('--five-pin', type=int, default=27, help='GPIO pin for 5-peso hopper motor')
    p.add_argument('--one-sensor', type=int, default=22, help='GPIO pin for 1-peso sensor')
    p.add_argument('--five-sensor', type=int, default=23, help='GPIO pin for 5-peso sensor')
