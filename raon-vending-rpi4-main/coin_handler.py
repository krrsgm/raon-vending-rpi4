...
class CoinAcceptor:
    ...
    def __init__(self, coin_pin=17, counter_pin=None):  # GPIO17 for coin input
        ...
        # Increase debounce to reduce noise-induced multiple detections
        self.debounce_time = 0.2  # 200ms debounce for Allan 123A-Pro
        # Pulse validation: ignore very short noise pulses and overly long signals
        # Increase minimum pulse width to filter spikes
        self.min_pulse_width = 0.02   # 20 ms
