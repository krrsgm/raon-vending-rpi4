...
class KioskConfigWindow(tk.Toplevel):
    ...
    def create_widgets(self):
        ...
        tk.Label(frame, text="Categories (one per line)", font=label_font, bg="#f0f4f8").grid(row=4, column=0, sticky='nw')
        self.categories_text = tk.Text(frame, height=4, font=field_font, width=50)
        self.categories_text.grid(row=4, column=1, sticky='ew', pady=6)
        ...
        tk.Label(frame, text="Group Members (one per line)", font=label_font, bg="#f0f4f8").grid(row=5, column=0, sticky='nw')
        self.members_text = tk.Text(frame, height=8, font=field_font, width=50)
        self.members_text.grid(row=5, column=1, sticky='ew', pady=6)
